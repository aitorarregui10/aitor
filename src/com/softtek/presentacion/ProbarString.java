...
public class ProbarString {
    public static void main(String[] args){
        ...
        System.out.println(frase.toUpperCase()+"\n"+frase.toLowerCase()+"\n " +
                "La frase tiene la siguiente longitud de cadena: "+frase.length());
        System.out.println("La posición de la letra primera m es: "+ frase.indexOf("m"));
        System.out.println(frase.substring(0,5));
        System.out.println(frase.substring(16,21));
        System.out.println(frase.substring(31,38));
    }
